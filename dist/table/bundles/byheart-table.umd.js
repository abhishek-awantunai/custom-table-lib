(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/router'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@byheart/table', ['exports', '@angular/core', '@angular/common/http', '@angular/router', '@angular/common'], factory) :
    (global = global || self, factory((global.byheart = global.byheart || {}, global.byheart.table = {}), global.ng.core, global.ng.common.http, global.ng.router, global.ng.common));
    ...
    var TableComponent = /** @class */ (function () {
        function TableComponent(_tableService, activatedRoute) {
        ...
        TableComponent.prototype.ngOnInit = function () {
            var _this = this;
            var idx = this.activatedRoute.pathFromRoot.length - 2;
            console.log(idx);
            while (this.sharedData == null && idx > 0) {
                this.sub = this.activatedRoute.pathFromRoot[idx].data.subscribe(function (subData) {
                    _this.config = subData;
                    _this.getTableData();
                });
                idx--;
            }
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(TableComponent, [{
            ...
            }], function () { return [{ type: TableService }, { type: i2.ActivatedRoute }]; }, { config: [{
                    type: i0.Input,
                    args: ['config']
                }] });
    })();
    ...
    MobileComponent.ɵcmp = i0.ɵɵdefineComponent({ type: MobileComponent, selectors: [["custom-mobile"]], decls: 2, vars: 0, template: function MobileComponent_Template(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵelementStart(0, "h1");
                i0.ɵɵtext(1, "Mobile component");
                i0.ɵɵelementEnd();
            }
        }, encapsulation: 2 });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(MobileComponent, [{
                type: i0.Component,
                args: [{
    ...
    var LadderComponent = /** @class */ (function () {
        function LadderComponent() {
        }
        return LadderComponent;
    }());
    LadderComponent.ɵfac = function LadderComponent_Factory(t) { return new (t || LadderComponent)(); };
    LadderComponent.ɵcmp = i0.ɵɵdefineComponent({ type: LadderComponent, selectors: [["custom-ladder"]], decls: 2, vars: 0, template: function LadderComponent_Template(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵelementStart(0, "h1");
                i0.ɵɵtext(1, "Ladder component");
                i0.ɵɵelementEnd();
            }
        }, encapsulation: 2 });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(LadderComponent, [{
                type: i0.Component,
                args: [{
    ...
    ByeartTableModule.ɵinj = i0.ɵɵdefineInjector({ factory: function ByeartTableModule_Factory(t) { return new (t || ByeartTableModule)(); }, providers: [TableService], imports: [[i1.HttpClientModule, i3.CommonModule, i2.RouterModule.forChild(route)]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ByeartTableModule, { declarations: [TableComponent, LadderComponent, MobileComponent], imports: [i1.HttpClientModule, i3.CommonModule, i2.RouterModule], exports: [TableComponent] }); })();
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(ByeartTableModule, [{
                type: i0.NgModule,
                args: [{
                        declarations: [TableComponent, LadderComponent, MobileComponent],
                        imports: [i1.HttpClientModule, i3.CommonModule, i2.RouterModule.forChild(route)],
